  ...
  public final class BasicBlock extends NodeWithNumber implements IBasicBlock<Instruction> {
            ...
            if (last instanceof Invoke) {
              ...
              MethodReference target =
                  MethodReference.findOrCreate(
                      l, loader.getReference(), call.clazzName, call.methodName, call.descriptor);
              try {
            ...
            if (goToAllHandlers) {
              ...
              if (element.getCatchClass() != null) {
                ClassLoaderReference loader =
                    DexCFG.this.getMethod().getDeclaringClass().getReference().getClassLoader();
    ...
    public String toString() {
      return "BB[Dex]"
          + getNumber()
          + " - "
          + dexMethod.getDeclaringClass().getReference().getName()
          + '.'
          + dexMethod.getName();
    }
