...
public class AstJavaModRef<T extends InstanceKey> extends AstModRef<T> {
  ...
  protected static class AstJavaRefVisitor<T extends InstanceKey> extends AstRefVisitor<T>
  ...
  protected static class AstJavaModVisitor<T extends InstanceKey> extends AstModVisitor<T>
      implements AstJavaInstructionVisitor {
