...
public abstract class ScopeMappingInstanceKeys implements InstanceKeyFactory {
   ...
   *
   * <p>The fact that we discover at most one {@link CGNode} per lexical parent relies on the
   ...
   *
   * <p>Note that it is possible to not find a {@link CGNode} corresponding to some lexical parent;
  ...
  public class ScopeMappingInstanceKey implements InstanceKey {
    ...
    public Iterator<Pair<CGNode, NewSiteReference>> getCreationSites(CallGraph CG) {
      return new FilterIterator<>(base.getCreationSites(CG), o -> o.fst.equals(creator));
    }
  }
  ...
  protected abstract Collection<CGNode> getConstructorCallers(
