...
public class APKCallGraphDriver {
  ...
  private static final boolean addAbstract =
      Boolean.parseBoolean(System.getProperty("addAbstract", "false"));
        ...
        apk1 -> {
          ...
          try {
            ...
            if (dumpIR) {
                  ...
                  for (IMethod m1 : cls.getDeclaredMethods()) {
                    if (m1.isAbstract()
                        && !Collections.disjoint(
                            CG.fst.getClassHierarchy().getPossibleTargets(m1.getReference()),
                            code)) {
                      code.add(m1);
                    }
                  }
              ...
              for (IMethod m2 : code) {
                System.err.println(
                    m2.getDeclaringClass().getName() + " " + m2.getName() + m2.getDescriptor());
              }
