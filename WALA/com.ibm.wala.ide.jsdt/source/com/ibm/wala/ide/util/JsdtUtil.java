...
public class JsdtUtil {
  ...
  public static Set<ModuleEntry> getJavaScriptCodeFromProject(String project)
  ...
  public static CGInfo buildJSDTCallGraph(Set<ModuleEntry> mes) {
    ...
    HeadlessUtil.parseModules(
        mes,
        new EclipseCompiler<IJavaScriptUnit>() {
          @Override
          ...
          public Parser<IJavaScriptUnit> getParser() {
            return new Parser<IJavaScriptUnit>() {
              ...
              public void processASTs(
                  Map<IJavaScriptUnit, EclipseSourceFileModule> files,
                  Function<Object[], Boolean> errors) {
                ...
                if (useCreateASTs) {
                  ...
                  parser.createASTs(
                      files.keySet().toArray(new IJavaScriptUnit[0]),
                      new String[0],
                      new ASTRequestor() {
                        @Override
