...
public class JavaScriptEclipseProjectPath
    extends EclipseProjectPath<IIncludePathEntry, IJavaScriptProject> {
  ...
  public static JavaScriptEclipseProjectPath make(
      IJavaScriptProject p, Set<Pair<String, Plugin>> models) throws IOException, CoreException {
  ...
  @Override
  public EclipseProjectPath<IIncludePathEntry, IJavaScriptProject> create(IProject project)
  ...
  protected void resolveProjectClasspathEntries(IJavaScriptProject project, boolean includeSource) {
    try {
      resolveClasspathEntries(
          project,
          Arrays.asList(project.getRawIncludepath()),
          Loader.EXTENSION,
          includeSource,
          true);
