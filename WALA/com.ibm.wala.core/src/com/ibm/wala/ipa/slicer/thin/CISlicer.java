...
public class CISlicer {
  ...
  public CISlicer(
      ...
      final ModRef<InstanceKey> modRef) {
    Map<Statement, Set<PointerKey>> mod = scanForMod(sdg, pa, modRef);
    Map<Statement, Set<PointerKey>> ref = scanForRef(sdg, pa, modRef);
  ...
  public static Map<Statement, Set<PointerKey>> scanForMod(
      SDG<InstanceKey> sdg, PointerAnalysis<InstanceKey> pa) {
  ...
  /**
   * Compute the set of pointer keys each statement mods. Be careful to avoid eager PDG construction
