...
public class LocalPathEdges {
   ...
   *
   * <p>For fact d2, paths[d2] gives a relation R=(n,d1) s.t. (&lt;s_p, d1&gt; -&gt; &lt;n,d2&gt;)
   * is a path edge.
   *
   * <p>Note that we handle paths of the form &lt;s_p, d1&gt; -&gt; &lt;n,d1&gt; specially, below.
   * We also handle paths of the form &lt;s_p, 0&gt; -&gt; &lt;n, d1> specially below.
   *
   * <p>We choose this somewhat convoluted representation for the following reasons: 1) of the (n,
   ...
   *
   * <p>Note that this representation is not good for merges. See below.
   *
   ...
   * structure tradeoff?
   *
   * <p>A map from integer (d1) -&gt; (IBinaryNonNegativeIntRelation)
   *
   * <p>For fact d1, paths[d1] gives a relation R=(n,d2) s.t. (&lt;s_p, d1&gt; -&gt; &lt;n,d2&gt;)
   * is a path edge.
   *
   * <p>We choose this somewhat convoluted representation for the following reasons: 1) of the (n,
   * d1, d2) tuple-space, we expect the set of n to be dense for a given (d1,d2) pair. However the
   ...
   *
   * <p>for fact d1, identityPaths[d1] gives the set of block numbers N s.t. for n \in N, &lt;s_p,
   ...
   *
   * <p>for fact d2, zeroPaths[d2] gives the set of block numbers N s.t. for n \in N, &lt;s_p, 0&gt;
   * -&gt; &lt;n, d2&gt; is a path edge.
   */
   ...
   * @return the sparse int set of d1 s.t. {@literal <s_p, d1> -> <n, d2>} are recorded as path
