 ...
 *
 * <p>This version differs in some ways from the POPL algorithm. In particular ...
 *
 * <ul>
 *   <li>to support exceptional control flow ... there may be several return sites for each call
 *       site.
...
public class TabulationSolver<T, P, F> {
   ...
   *
   * <p>Logically, this represents a set of edges (s_p,d_i) -&gt; (n, d_j). The data structure is
   ...
   *
   * <p>Logically, this represents a set of edges (c,d_i) -&gt; (s_p, d_j). The data structure is
   * chosen to attempt to save space over representing each edge explicitly.
   */
   ...
   *
   * <p>It's unfortunate that this method exits.
   */
   ...
   *
   * <p>[23] for each d5 s.t. {@literal <s_p,d2> -> <returnSite(c),d5>} ..
   *
   ...
   * @param d4 a fact s.t. {@literal <c, d4> -> <callee, d2>} was recorded as call flow and
   *     {@literal <callee, d2>} is the source of the summary edge being applied
  ...
  protected void processParticularCallee(
    ...
    final Collection<T> returnSitesForCallee =
   ...
   * -&gt;&lt;n, z&gt;.
   *
   * <p>let \alpha be the merge function. then instead of &lt;s_p,i&gt; -&gt; &lt;n,j&gt;, we
   * propagate &lt;s_p,i&gt; -&gt; &lt;n, \alpha(j,x,y,z) &gt; !!!
   *
   * <p>return -1 if no fact should be propagated
   */
  ...
  /**
   * @return set of d1 s.t. (n1,d1) -&gt; (n2,d2) is recorded as a summary edge, or null if none
   *     found
  ...
  /**
   * Indicates that due to a path edge &lt;s_p, d1&gt; -&gt; &lt;n, d2&gt; (the 'edge' parameter)
   * and a normal flow function application, a new path edge &lt;s_p, d1&gt; -&gt; &lt;m, d3&gt; was
   * created. To be overridden in subclasses. We also use this function to record call-to-return
   * flow.
   */
  @SuppressWarnings("unused")
  ...
  /**
   * Indicates that due to a path edge 'edge' &lt;s_p, d1&gt; -&gt; &lt;n, d2&gt; and application of
   * a call flow function, a new path edge &lt;calleeEntry, d3&gt; -&gt; &lt;calleeEntry, d3&gt; was
  ...
  /**
   * Combines [25] and [26-28]. In the caller we have a path edge 'edgeToCallSite' &lt;s_c, d3&gt;
   * -&gt; &lt;c, d4&gt;, where c is the call site. In the callee, we have path edge
   * 'calleeSummaryEdge' &lt;s_p, d1&gt; -&gt; &lt;e_p, d2&gt;. Of course, there is a call edge
   * &lt;c, d4&gt; -&gt; &lt;s_p, d1&gt;. Finally, we have a return edge &lt;e_p, d2&gt; -&gt;
   * &lt;returnSite, d5&gt;.
   */
  @SuppressWarnings("unused")
  protected void newSummaryEdge(
      PathEdge<T> edgeToCallSite, PathEdge<T> calleeSummaryEdge, T returnSite, int d5) {}
}
