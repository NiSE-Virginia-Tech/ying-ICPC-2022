...
public class StringStuff {
  ...
  /**
   * Parse method descriptor to obtain description of method's return type. TODO: tune this ..
   * probably combine with parseForParameters.
   *
  ...
  public static ImmutableByteArray parseForPackage(ImmutableByteArray name, int start, int length)
    ...
    try {
      ...
      throw new IllegalArgumentException(
          "invalid name " + name + " start: " + start + " length: " + length, e);
    }
  }
   ...
   *
   * <p>TODO: inefficient; needs tuning.
   *
   * @return an ImmutableByteArray that represents the package, or null if it's the unnamed package
  ...
  /**
   * Parse an array descriptor to obtain number of dimensions in corresponding array type. b:
   ...
   * @throws IllegalArgumentException if b is null
   */
  public static ImmutableByteArray parseForInnermostArrayElementDescriptor(
      ImmutableByteArray b, int start, int length) {
   ...
   * Convert '/' to '.' in names.
   *
   * @return a String object obtained by replacing the forward slashes ('/') in the String passed as
   *     argument with ('.').
   ...
   * @return a String object obtained by replacing the dollar signs ('S') in the String passed as
   *     argument with ('.').
   * @throws IllegalArgumentException if path is null
   */
